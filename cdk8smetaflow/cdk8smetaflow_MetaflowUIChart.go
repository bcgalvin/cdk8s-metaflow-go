...
// The jsii proxy struct for MetaflowUIChart
type jsiiProxy_MetaflowUIChart struct {
	internal.Type__cdk8sChart
}

func (j *jsiiProxy_MetaflowUIChart) Deployment() cdk8splus22.Deployment {
...
func (j *jsiiProxy_MetaflowUIChart) Labels() *map[string]*string {
...
func (j *jsiiProxy_MetaflowUIChart) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_MetaflowUIChart) Node() constructs.Node {
...
func (j *jsiiProxy_MetaflowUIChart) Service() cdk8splus22.Service {
...
func (m *jsiiProxy_MetaflowUIChart) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (m *jsiiProxy_MetaflowUIChart) GenerateObjectName(apiObject cdk8s.ApiObject) *string {
	var returns *string
...
func (m *jsiiProxy_MetaflowUIChart) ToJson() *[]interface{} {
...
func (m *jsiiProxy_MetaflowUIChart) ToString() *string {
	var returns *string
